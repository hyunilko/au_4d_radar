...
private:
    ...
    void startPcanRxDispatch(void);
    void stopPcanRxDispatch(void);
    void pcanRxDispatchLoop(void);
    ...
    std::atomic<bool> pcan_rx_running_{false};
    std::thread pcan_rx_thread_;
